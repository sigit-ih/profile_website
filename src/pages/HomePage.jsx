...
export default function HomePage({ t }) {
  return (
    <div className="home-page relative flex flex-col md:flex-row h-screen lg:h-full p-[4vw] pt-[60px] lg:pt-0 items-center overflow-hidden">
      ...
      <div className="home-left w-full md:w-1/2 md:min-w-min pt-[1vw] sm:pt-10 md:pr-[4.5vw] md:py-10 md:border-r-4 md:border-gray-200 dark:md:border-gray-800 md:text-right">
        <h1 className="text-[6vw] sm:text-5xl md:text-4xl font-bold text-[#4169E1] dark:text-orange-400 mb-0 sm:mb-2 md:mb-0">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-flex items-center gap-2 w-full sm:w-auto rounded-lg font-semibold text-[3vw] sm:text-lg md:text-md sm:px-32 md:px-6 py-[2vw] sm:py-3 bg-[#4169E1] dark:bg-orange-400 hover:bg-[#365ac0] dark:hover:bg-orange-500 text-white dark:text-gray-800 text-center justify-center"
