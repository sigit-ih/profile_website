...
export default function Navbar({ t, i18n, navItems }) {
  ...
  return (
    <div className="navbar absolute lg:static flex justify-between lg:justify-normal lg:flex-col w-full lg:w-64 lg:min-w-64 h-20 lg:min-h-screen px-6 lg:px-0 z-20 bg-white dark:bg-gray-700 shadow-lg">
          ...
          <div className="toggle-lang grow h-7 my-auto">
            <button
              ...
              className={`h-full px-3 py-1 rounded-l ${
                currentLang === "id"
                  ? "bg-[#4169E1] dark:bg-orange-400 text-gray-100 dark:text-gray-800"
      ...
      <nav className="navbar-hamburger flex md:hidden h-full items-center">
        ...
        {isOpenMenu && (
          <div className="absolute top-0 right-0 z-60 w-screen h-screen justify-items-center text-center text-lg sm:text-xl space-y-6 flex-col p-4 bg-gray-100 dark:bg-gray-800">
            <button
