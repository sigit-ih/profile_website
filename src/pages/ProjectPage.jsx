...
export default function ProjectPage() {
  ...
  return (
    <div className="project-page flex flex-col h-screen p-[5vw] lg:p-10 pt-[100px] lg:pt-10 overflow-hidden">
      <h2 className="project-title h-auto text-2xl sm:text-3xl font-bold mb-[3vw] sm:mb-6 mx-auto text-center text-[#4169E1] dark:text-orange-400">
        {t("project")}
      </h2>
      <div className="project-lists h-[70vh] sm:h-[72vh] md:h-[75vh] lg:h-[82vh] grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 lg:gap-6 items-stretch overflow-y-auto place-items-center">
        {projects.map((project, index) => (
          <div
            key={index}
            className="flex flex-col bg-gray-100 dark:bg-gray-700 border-2 border-gray-900 dark:border-white rounded-2xl shadow md:shadow-lg p-[3vw] sm:p-6"
          >
