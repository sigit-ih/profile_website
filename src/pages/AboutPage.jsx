...
export default function AboutPage({ t }) {
  return (
    <div className="about-page flex flex-col lg:flex-row h-screen w-full max-w-full overflow-hidden bg-white dark:bg-gray-900 justify-start text-left p-[5vw] lg:p-10 pt-[100px] lg:pt-10">
      ...
      <div className="about-right flex flex-col lg:w-1/2 lg:min-w-[450px] flex-grow w-full min-h-0">
        ...
        <section className="section-timeline h-auto items-center justify-center min-h-[30vh]">
